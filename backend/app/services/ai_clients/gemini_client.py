...
class GeminiClient:
    ...
    def __init__(self, api_key: str, base_url: str | None = None, config: AIClientConfig | None = None):
        """初始化
        ...
        self.client = httpx.AsyncClient(
            timeout=httpx.Timeout(
                connect=http_cfg.connect_timeout, read=http_cfg.read_timeout, write=http_cfg.write_timeout, pool=http_cfg.pool_timeout
            )
        )
    ...
    async def chat_completion(
        ...
        for part in parts:
            if 'text' in part:
                ...
                tool_calls.append({'id': f'call_{fc["name"]}', 'type': 'function', 'function': {'name': fc['name'], 'arguments': fc.get('args', {})}})
